...
ckpt_path="/pubshare/fwk/ppo_ckpts/2024-08-23-06-54-target9"
root_dir="/home/jovyan/notebook/f-divergence-dpo/outputs/ppo_gt_target9_imdb"
...
done | CUDA_VISIBLE_DEVICES=5 ROOT_DIR=$root_dir xargs -I {} -P 1 python metrics/imdb/imdb_eval_metrics.py --sft true --checkpoint $ckpt_path/{}/model.safetensors --divergence reverse_kl
