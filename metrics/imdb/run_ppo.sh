...
ckpt_path="/pubshare/fwk/ppo_ckpts/2024-09-10-12-50-notarget"
root_dir="/home/jovyan/notebook/f-divergence-dpo/outputs/ppo_gt_notarget"
...
checkpoints=("checkpoint_0000" "best_checkpoint" "checkpoint_0100" "checkpoint_0200" "checkpoint_0300" "checkpoint_0400" "checkpoint_0500" "checkpoint_0600")
...
done | CUDA_VISIBLE_DEVICES=7 ROOT_DIR=$root_dir xargs -I {} -P 1 python metrics/imdb/imdb_eval_metrics.py --sft true --checkpoint $ckpt_path/{}/model.safetensors --divergence reverse_kl
