...
ckpt_path="/pubshare/fwk/ppo_ckpts/2024-08-23-01-50-target6"
root_dir="/home/jovyan/notebook/f-divergence-dpo/outputs/ppo_gt_target6_imdb"
...
checkpoints=("checkpoint_0000" "best_checkpoint" "checkpoint_0100" "checkpoint_0200" "checkpoint_0300" "checkpoint_0400" "checkpoint_0500" "checkpoint_0600" "checkpoint_0700" "checkpoint_0800" "checkpoint_0900" "checkpoint_1000" "checkpoint_1100" "checkpoint_1200" "checkpoint_1300")
...
done | CUDA_VISIBLE_DEVICES=4 ROOT_DIR=$root_dir xargs -I {} -P 1 python metrics/imdb/imdb_eval_metrics.py --sft true --checkpoint $ckpt_path/{}/model.safetensors --divergence reverse_kl
...
# CUDA_VISIBLE_DEVICES=4 ROOT_DIR="/pubshare/fwk/ppo_ckpts/2024-08-23-01-50-target6" python metrics/imdb/imdb_eval_metrics.py --sft true --checkpoint /pubshare/fwk/ppo_ckpts/2024-08-23-01-50-target6/checkpoint_0100/model.safetensors --divergence reverse_kl